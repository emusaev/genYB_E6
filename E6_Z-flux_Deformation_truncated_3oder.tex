...
\end{verbatim}}
% orig
%  - 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} k_{i7}^{t} k_{i8}^{u} \partial_{u}{k_{i9}^{l}} \rho^{i1 i2 i8} \rho^{i3 i4 i5} \rho^{i6 i7 i9} s2 s5 + 5/2592 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i8} \rho^{i2 i4 i9} \rho^{i5 i6 i7} s2 s5 - 5/1728 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i8} \rho^{i2 i4 i5} \rho^{i6 i7 i9} s2 s5 - 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i4} \rho^{i2 i8 i9} \rho^{i5 i6 i7} s2 s5 + 5/2592 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} k_{i7}^{t} k_{i8}^{u} \partial_{u}{k_{i9}^{l}} \rho^{i1 i2 i3} \rho^{i4 i5 i6} \rho^{i7 i8 i9} s2 s5 + 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} k_{i7}^{t} k_{i8}^{u} \partial_{u}{k_{i9}^{l}} \rho^{i1 i2 i9} \rho^{i3 i4 i5} \rho^{i6 i7 i8} s2 s5 + 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{t} \partial_{u}{k_{i9}^{u}} \rho^{i1 i3 i9} \rho^{i2 i4 i5} \rho^{i6 i7 i8} s2 s5
% end_orig
\begin{dmath*}[compact, spread=2pt]
...
% End TeX comment
% orig
%  - 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} k_{i7}^{t} k_{i8}^{u} \partial_{u}{k_{i9}^{l}} \rho^{i1 i2 i8} \rho^{i3 i4 i5} \rho^{i6 i7 i9} s2 s5 + 5/2592 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i8} \rho^{i2 i4 i9} \rho^{i5 i6 i7} s2 s5 - 5/1728 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i8} \rho^{i2 i4 i5} \rho^{i6 i7 i9} s2 s5 + 5/10368 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i10}^{l} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} \rho^{i1 i2 i3} f_{i7 i8}^{i4} k_{i9}^{t} \rho^{i10 i7 i8} \rho^{i5 i6 i9} s2 s5 + 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i10}^{l} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} \rho^{i1 i2 i3} f_{i7 i8}^{i10} k_{i9}^{t} \rho^{i4 i5 i6} \rho^{i7 i8 i9} s2 s5 + 5/5184 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{m} k_{i3}^{n} k_{i4}^{p} k_{i5}^{q} k_{i6}^{r} k_{i7}^{t} k_{i8}^{u} \partial_{u}{k_{i9}^{l}} \rho^{i1 i2 i9} \rho^{i3 i4 i5} \rho^{i6 i7 i8} s2 s5 + 5/10368 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i10}^{l} \rho^{i1 i2 i3} f_{i2 i3}^{i4} k_{i4}^{m} k_{i5}^{n} k_{i6}^{p} k_{i7}^{q} k_{i8}^{r} k_{i9}^{t} \rho^{i10 i5 i6} \rho^{i7 i8 i9} s2 s5 - 5/2592 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i9} \rho^{i2 i4 i8} \rho^{i5 i6 i7} s2 s5 + 5/1728 e6 Z^{A B}_{C} d_{A B D} E_{k}^{C} E_{l}^{D} \epsilon_{m n p q r t} k_{i1}^{k} k_{i2}^{l} k_{i3}^{m} k_{i4}^{n} k_{i5}^{p} k_{i6}^{q} k_{i7}^{r} k_{i8}^{u} \partial_{u}{k_{i9}^{t}} \rho^{i1 i3 i9} \rho^{i2 i4 i5} \rho^{i6 i7 i8} s2 s5
% end_orig
\begin{dmath*}[compact, spread=2pt]
